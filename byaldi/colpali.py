...
import srsly
import torch
from colpali_engine.models import ColPali, ColPaliProcessor, ColQwen2, ColQwen2Processor, ColQwen2_5_Processor, ColQwen2_5
...
class ColPaliModel:
    def __init__(
        ...
        **kwargs,
        ...
        if (
            ...
            and "colqwen2.5" not in pretrained_model_name_or_path.lower()
    ...
    def search_image_text(
        ...
        with torch.inference_mode():
            ...
            embeddings_query = torch.cat([text_outputs, image_outputs], dim=1)
